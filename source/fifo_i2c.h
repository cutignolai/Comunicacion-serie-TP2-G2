...
#define I2C_FIFO_MAX_N      3          // Maximum amount of FIFO queues
...
// FIFO ID
typedef uint8_t I2C_fifo_id_t;

// FIFO VALUE TYPE
typedef i2c_transaction_t I2C_fifo_value_t;
 ...
 */
size_t I2C_FIFO_WriteToBuffer(I2C_fifo_id_t id, I2C_fifo_value_t* data_ptr, size_t data_size);
